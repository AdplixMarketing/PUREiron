...
export default function AboutPage() {
  return (
    <div className="pt-24 pb-24">
      ...
      {/* Story sections */}
      <section className="max-w-[1200px] mx-auto px-6 sm:px-10 lg:px-16 py-32">
        <motion.div
      ...
      {/* Stats */}
      <section className="bg-iron-dark py-24 border-y border-white/5">
        <div className="max-w-[1200px] mx-auto px-6 sm:px-10 lg:px-16 grid grid-cols-2 md:grid-cols-4 gap-12">
      ...
      {/* CTA */}
      <section className="max-w-3xl mx-auto px-6 sm:px-10 py-32 text-center">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
